...
class tape_sort_test : public ::testing::Test {
 protected:
  ...
  void run_sort_and_verify(std::vector<int32_t> data, std::size_t memory_limit, const std::string& test_name) {
    ...
    int32_t val;
    while (out.read(val)) result.push_back(val);
